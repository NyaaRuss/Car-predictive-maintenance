...
class WilberforceApp:
    ...
    def render_sidebar(self):
        ...
        # MANUAL INPUT SECTION - ADDED THIS
        ...
        if not st.session_state.use_manual_input:
            ...
            simulation_mode = st.sidebar.selectbox(
                "Simulation Mode",
                ["Normal Operation", "Developing Fault", "Critical Condition"],
                index=["Normal Operation", "Developing Fault", "Critical Condition"].index(st.session_state.simulation_mode)
            )
        else:
